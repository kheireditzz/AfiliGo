...
const contentJs = `// Flow Ai Extension v6.0 - Luxury Dark AffiliateGo Theme & Ultra-Compact Touch Studio
(function() {
...
console.log("content.js v6.0 with luxury dark theme and reliable mobile tap generated successfully!");
