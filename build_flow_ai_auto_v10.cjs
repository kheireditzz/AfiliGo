...
const contentJs = `// Flow Ai Auto v10.0 - Full Video & Nano Banana Image Studio with 2-Way Sync & Auto-Downloader
(function() {
...
console.log("content.js v10.0 with Nano Banana Suite, Auto Video Download, and 2-Way Sync successfully built!");
