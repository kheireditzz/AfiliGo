...
const contentJs = `// Flow Ai Extension v4.0 - Compact Top-Center Sequential Per-Scene & Image Injector
(function() {
...
console.log("Flow Ai Extension v4.0 with Top-Center layout, compact sizing, image injection, and sequential per-scene runner successfully generated!");
