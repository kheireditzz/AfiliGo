...
const contentJs = `// Flow Ai Extension v4.5 - Auto-Sequential Scene Runner & Robust Event Listeners
(function() {
...
console.log("content.js v4.5 with responsive scene tab buttons and Auto-Runner generated successfully!");
